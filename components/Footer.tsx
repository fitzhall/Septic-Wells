      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-2">{siteConfig.business.tagline}</p>
            <p className="text-sm">
              Licensed & Insured
              <br />
              Serving the community since {siteConfig.about.yearEstablished}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href={`tel:${siteConfig.business.phone}`} className="hover:text-primary-400">
                  📞 {siteConfig.business.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${siteConfig.business.email}`} className="hover:text-primary-400">
